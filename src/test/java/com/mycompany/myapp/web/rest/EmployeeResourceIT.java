...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).email(DEFAULT_EMAIL).salary(DEFAULT_SALARY);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).email(UPDATED_EMAIL).salary(UPDATED_SALARY);
        return employee;
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).email(UPDATED_EMAIL).salary(UPDATED_SALARY);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.email(UPDATED_EMAIL).salary(UPDATED_SALARY);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).email(UPDATED_EMAIL).salary(UPDATED_SALARY);
